...
export default function ChatBot({ emails = [], onNavigateCategory, onSearch, onSelectEmail, onGoDashboard, onRecategorize }) {
    ...
    const emailSummary = useMemo(() => {
        ...
        if (deadlineCandidates.length > 0) {
            summary += `---  DEADLINE CANDIDATES (${deadlineCandidates.length} emails with deadline/due-date keywords) ---\n`;
